...
xi=dist-del
! Now fit t=a*xi^2+b*xi+t0
a=0.5*(t0-2*t1+t2)
b=t1-t0-a
slw=rad*(2*a*xi+b)           ! slowness in sec/radian
if(depth<0.01.or.dist>14.) return

! if ray departs upward, make slw negative
x=depth
y=dist
if(depth<35.) then
  if(x>20.1224-.689202*y+0.969798*y**2) slw=-slw
else if(depth<120.) then
  if(x>35.4508-1.65749*y+1.19515*y**2) slw=-slw
else if(depth<210.) then  
  if(y<10.5748-.457588E-01*x+0.162821E-03*x**2) slw=-slw
else if(depth<410.) then
  if(y<8.43082-.582100E-04*x+0.180506E-04*x**2) slw=-slw
else
  if(x>756.890-94.6867*y+6.45772*y**2) slw=-slw
endif  
...
! if ray departs upward, make slw negative
if(depth<0.01.or.dist>15.) return
x=depth
y=dist
if(depth<35.) then
  if(x>20.1318-.715313*y+0.970217*y**2) slwS=-slwS
else if(depth<220.) then  
  if(x>34.8573-.200746*y+1.17803*y**2) slwS=-slwS
else if(depth<252) then
  if(y<54.7499-.362455*x+0.727583E-03*x**2) slwS=-slwS
else if(depth<410.) then
  if(y<8.43082-.582100E-04*x+0.180506E-04*x**2) slwS=-slwS
else
  if(x>756.890-94.6867*y+6.45772*y**2) slwS=-slwS
endif  
